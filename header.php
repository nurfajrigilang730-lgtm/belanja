		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6281364052264</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> smpyppbb@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>SMKS Pembangunan Bagan Batu</span>
				</div>
			</center>
		</div>
	</div>
