...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #ff8d87; border-bottom: 2px solid #ff8d87;">SPW SMK Pembangunan Bagan Batu adalah singkatan dari Sekolah Pencetak Wirausahawan, yang merupakan sebuah program atau inisiatif di SMKS Pembangunan Bagan Batu. Program ini bertujuan untuk menciptakan lulusan yang kreatif, inovatif, dan kompetitif, serta memiliki kemampuan wirausaha.</h4>
